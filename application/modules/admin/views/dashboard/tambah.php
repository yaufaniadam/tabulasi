<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Tambah Dashboard </h1>        
</section>
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('admin/dashboard/import_dashboard/'.$file_excel), 'class="form-horizontal"' );

          echo "<p class='alert alert-warning'>Data Periode " . $sheet['1']['D'] . " " . $sheet['1']['E'] . "</p>";
          ...
          <?php
            ...
            echo "  <a class='btn btn-warning' href='".base_url("admin/dashboard/tambah")."'>Cancel</a>";
          }
          ...
          echo form_open_multipart(base_url('admin/dashboard/tambah'), 'class="form-horizontal"' )?> 
