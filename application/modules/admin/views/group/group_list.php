  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-list"></i> &nbsp; Peranan Pengguna</h4>
        </div>
        <div class="col-md-6 text-right">
          <a href="<?= base_url('admin/group/add'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Peranan</a>
        </div>
...
<div id="confirm-delete" class="modal fade" role="dialog">
 ...
 <script>
    ...
    $("#pengguna .submenu_usergroup").addClass('active');
  </script>