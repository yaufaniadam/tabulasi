	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li id="operasional" class="treeview">
				...
				<ul class="treeview-menu">
					<li class="lap_bulanan"><a href="<?= base_url('laporankeuangan/lap_bulanan'); ?>"> &nbsp;Bulanan</a>
					</li>
					<li class="lap_akumulasi"><a href="<?= base_url('laporankeuangan/lap_akumulasi'); ?>">
							&nbsp;Akumulasi</a>
					</li>
				</ul>
			</li>
			...
			<li id="regulasi_kemaslahatan">
				<a href="<?= base_url('kemaslahatan/regulasi_tentang_kemaslahatan'); ?>"><span>Regulasi Tentang
						Kemaslahatan
					</span></a>
			</li>
			<li class="header">LAPORAN KINERJA</li>
			<li id="pencapaian_perbidang">
				<a href="<?= base_url('laporankinerja/pencapaian_perbidang'); ?>">
					<span>Pencapaian Output per-Bidang</span>
				</a>
			</li>
			<li id="penyerapan_perbidang">
				<a href="<?= base_url('laporankinerja/penyerapan_perbidang'); ?>">
			...
			<li id="datajemaah" class="treeview">
				...
				<ul class="treeview-menu">
					...
					<li class="kuota"><a href="<?= base_url('datajemaah/kuota'); ?>"> &nbsp;Kuota Jemaah Berangkat</a>
					</li>
					<li class="batal"><a href="<?= base_url('datajemaah/batal'); ?>"> &nbsp;Data Jemaah Batal</a></li>
					<li class="bpih"><a href="<?= base_url('datajemaah/realisasi_bpih'); ?>"> &nbsp;Realisasi BIPIH &
							BPIH</a>
					</li>
				</ul>
			</li>
			...
			<li id="dokumen" class="treeview">
				...
				<ul class="treeview-menu">
					<li class="regulasi"><a href="<?= base_url('nonkeuanganbpkh/dokumen/regulasi'); ?>">Regulasi</a>
					</li>
