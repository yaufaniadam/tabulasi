    ...
    <?php if (is_admin() == 1) { ?>
      ...
      <ul class="sidebar-menu">
        ...
        <li id="alokasi_produk_perbankan" class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="sebaran_dana_haji"><a href="<?= base_url('keuanganhaji/sebaran_dana_haji'); ?>">Penempatan Dana Kelolaan di BPS-BPIH</a></li>
            <li class="posisi_penempatan_produk"><a href="<?= base_url('keuanganhaji/posisi_penempatan_produk'); ?>">Dana Haji yang Ditempatkan</a></li>
        ...
        <li id="alokasi_produk_investasi" class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="reksadana"><a href="<?= base_url('keuanganhaji/reksadana_terproteksi_syariah'); ?>">Reksadana</a></li>
        ...
        <li id="nilai_manfaat" class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="per_instrumen"><a href="<?= base_url('keuanganhaji/nilaimanfaat/per_instrumen'); ?>">Produk Investasi</a></li>
            ...
            <li class="produk"><a href="<?= base_url('keuanganhaji/nilaimanfaat/produk'); ?>">Produk Penempatan</a></li>
          </ul>
        </li>
        ...
        <li id="lap_arus_kas">
          <a href="<?= base_url('laporankeuangan/lap_arus_kas'); ?>">
            <span>Laporan Arus Kas</span>
          </a>
        </li>
        <li id="realisasi_anggaran">
          <a href="<?= base_url('laporankeuangan/realisasi_anggaran'); ?>">
        ...
        <li id="makro" class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="laporan_industri_keuangan_syariah"><a href="<?= base_url('makro/laporan_industri_keuangan_syariah'); ?>">Laporan Industri Keuangan Syariah</a></li>
        ...
        <li id="dokumen" class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="regulasi"><a href="<?= base_url('nonkeuanganbpkh/dokumen/regulasi'); ?>">Regulasi</a></li>
            <li class="sdm"><a href="<?= base_url('nonkeuanganbpkh/dokumen/sdm'); ?>">SDM</a></li>
            <li class="aset_nontunai"><a href="<?= base_url('nonkeuanganbpkh/dokumen/aset_nontunai'); ?>">Aset Non Tunai</a></li>
            ...
            <li class="laporan_kinerja"><a href="<?= base_url('nonkeuanganbpkh/dokumen/laporan_kinerja'); ?>"><span>Laporan Kinerja</span></a></li>
            <li class="materi_video_dan_paparan"><a href="<?= base_url('nonkeuanganbpkh/dokumen/materi_video_dan_paparan'); ?>"><span>Materi Video dan Paparan</span></a></li>
          </ul>
        </li>
