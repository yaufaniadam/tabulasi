...
<html lang="en">
	<head>
		  <title><?=isset($title)?$title:'Database Ekonomi dan Keuangan BPKH RI' ?></title>
		  <!-- Tell the browser to be responsive to screen width -->
		  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
		  <meta name = "keywords" content = "Database Ekonomi dan Keuangan BPKH RI" />
      	  <meta name = "description" content = "Database Ekonomi dan Keuangan BPKH RI" />
