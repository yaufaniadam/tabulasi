<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> Alokasi Investasi BPKH 
    ...
    <a href="<?=base_url('alokasi/tambah_alokasi_investasi'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i>&nbsp;  Tambah Data</a>

    <a href="<?=base_url('alokasi/export_alokasi_investasi/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
          ...
          <tr class="mainheadingtable">
            <th class="first"><strong>Uraian</strong></td> 
              ...
              <th style="text-align: right; width:20%"><?= konversiBulanAngkaKeNama($row['bulan']); ?>
                ...
                <a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger" data-href="<?=base_url('alokasi/hapus_alokasi_investasi/'.$row['id_alokasi_investasi']); ?>" data-toggle="modal" data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>
