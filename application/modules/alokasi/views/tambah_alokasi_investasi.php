    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('alokasi/import_alokasi_investasi/'.$file_excel), 'class="form-horizontal"' );
          ...
          <?php
            ...
            echo "  <a class='btn btn-warning' href='".base_url("alokasi/alokasi_investasi")."'>Cancel</a>";
          }
          ...
          echo form_open_multipart(base_url('alokasi/tambah_alokasi_investasi'), 'class="form-horizontal"' )?> 
            <div class="form-group">
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/alokasi_investasi_bpkh.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
