<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Laporan Penyerapan Anggaran per Bidang 
		<a href="<?=base_url('bpih/tambah_penyerapan_perbidang'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i>&nbsp;  Tambah Data</a>

		<a href="<?=base_url('bpih/export_penyerapan_perbidang/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
	</h1>
...
<section class="content"> 	
  	<div class="row" >
  		...
  		<div class="well well-sm pre-scrollable" style="overflow-x: scroll; min-height:500px;">
			<table id="table1" class="table table-striped table-bordered" style="width:<?=count($penyerapan_perbidang)*200; ?>px;;min-width: 100%;">
				...
				<tr>
					...
					<th style="text-align: right"><?=$row['bulan']; ?> &nbsp;
						...
						<a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger" data-href="<?=base_url('bpih/hapus_penyerapan_perbidang/'.$row['id']); ?>" data-toggle="modal" data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>
				...
				<tr>
					...
					<?php foreach($penyerapan_perbidang as $row ) { ?>
						<td style="text-align: right;"><?=$row['sekretariat_badan_pelaksana'];?></td>		
					<?php } ?>	
				</tr>	
				<tr>
					<td>
					...
					<?php foreach($penyerapan_perbidang as $row ) { ?>
						<td style="text-align: right;"><?=$row['sekretariat_dewan_pengawas'];?></td>		
					<?php } ?>	
				</tr>
