<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Produk Penempatan
		<a href="<?=base_url('keuanganhaji/nilaimanfaat/tambah_nilai_manfaat_produk'); ?>" class="btn btn-warning btn-sm"><i
				class="fas fa-plus"></i>&nbsp; Tambah Data</a>

		<a href="<?=base_url('keuanganhaji/nilaimanfaat/export_nilai_manfaat_produk/'.$thn); ?>"
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="btn-group" role="group" style="margin-bottom: 20px;">
				...
				<a href="<?=base_url('keuanganhaji/nilaimanfaat/produk'); ?>" class="btn disabled btn-md btn-success">Dana Haji yang
					Ditempatkan</a>
				<a href="<?= base_url('keuanganhaji/nilaimanfaat/penempatan_di_bpsbpih'); ?>"
					...
					<tbody>
						...
						<tr>
							...
							<td style="text-align: center;"> <a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger"
									data-href="<?=base_url('keuanganhaji/nilaimanfaat/hapus_produk/'.$produk['id']); ?>"
