<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Tambah Portfolio Investasi </h1>        
</section>
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('keuanganhaji/postertentu/import_portfolio_investasi/'.$file_excel), 'class="form-horizontal"' );
          ...
          <?php
            ...
            echo "  <a class='btn btn-warning' href='".base_url("keuanganhaji/postertentu/portfolio_investasi")."'>Cancel</a>";
          }
          ...
          echo form_open_multipart(base_url('keuanganhaji/postertentu/tambah_portfolio_investasi'), 'class="form-horizontal"' )?> 
            <div class="form-group">
             <p class="alert alert-warning"><i class="fa fa-exclamation-triangle"></i><strong> Panduan Import Data</strong></p>
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/keuanganhaji/postertentu/portfolio_investasi_bpkh.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
