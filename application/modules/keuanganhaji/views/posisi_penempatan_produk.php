<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> &nbsp; Dana Haji yang Ditempatkan
		...
		<a href="<?=base_url('keuanganhaji/tambah_posisi_penempatan_produk'); ?>" class="btn btn-warning btn-sm"><i
				class="fas fa-plus"></i>&nbsp; Tambah Data</a>
		<a href="<?=base_url('keuanganhaji/export_posisi_penempatan_produk/'.$thn); ?>" class="btn btn-success btn-sm"><i
				...
				<table class="keuangan table table-striped table-bordered">
					...
					<tr>
						...
						<td style="text-align: center;"> <a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger"
								data-href="<?=base_url('keuanganhaji/hapus_posisi_penempatan_produk/'.$row['id']); ?>"
