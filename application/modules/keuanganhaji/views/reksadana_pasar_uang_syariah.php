 <section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Reksadana Pasar Uang Syariah  <a href="<?=base_url('keuanganhaji/tambah_reksadana_pasar_uang_syariah'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i>&nbsp;  Tambah Data</a>

    <a href="<?=base_url('keuanganhaji/export_reksadana_pasar_uang_syariah/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
</h1>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12"> 
        ...
        <?php if($reksadana_pasar_uang_syariah) { ?>
        ...
        <div class="box-body smy-form-body box-keuangan">        
          ...
          <table class="keuangan table table-striped table-bordered" style="width:2200px;min-width: 100%;">
            ...
            <?php foreach ($reksadana_pasar_uang_syariah as $row) { 
