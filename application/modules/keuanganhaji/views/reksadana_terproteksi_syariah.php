<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Reksadana Terproteksi Syariah  
    ...
    <a href="<?=base_url('keuanganhaji/tambah_reksadana_terproteksi_syariah'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i>&nbsp;  Tambah Data</a>

    <a href="<?=base_url('keuanganhaji/export_reksadana_terproteksi_syariah/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
