				...
				<tr>
					...
					<td class="text-center">
						...
						<a style="color:#fff;" title="Lihat Detail" class="btn btn-xs btn-info"
							href="<?= base_url($this->router->fetch_class() . '/detail_sbssn_usd/' . $row['bulan'] .'/' .$row['tahun']); ?>">
						...
						<a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger"
							...
							<a href="<?= base_url('keuanganhaji/export_sbssn_usd/'. $row['bulan'] .'/' . $thn); ?>" class="btn btn-success btn-xs"><i
