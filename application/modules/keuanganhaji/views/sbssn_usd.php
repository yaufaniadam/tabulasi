<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Surat Berharga Negara (SBN) - SBSSN USD  

    <a href="<?=base_url('keuanganhaji/tambah_sbssn_usd'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i>&nbsp;  Tambah Data</a>
    <a href="<?=base_url('keuanganhaji/export_sbssn_usd/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
  </h1>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">     
        ...
        <p class="text-success">*) Dalam USD Juta</p>
