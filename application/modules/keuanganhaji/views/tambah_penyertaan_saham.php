<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Tambah Penyertaan Saham </h1>        
</section>
      ...
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          <?php
            ...
            echo " <a class='btn btn-warning' href='".base_url("keuanganhaji/penyertaan_saham")."'>Cancel</a>";
          }
          ...
          echo form_open_multipart(base_url('keuanganhaji/tambah_penyertaan_saham'), 'class="form-horizontal"' )?> 
            <div class="form-group">
             <p class="alert alert-warning"><i class="fa fa-exclamation-triangle"></i><strong> Panduan Import Data</strong></p>
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/keuanganhaji/pengelolaan/penyertaan_saham.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
...
<script>
    ...
    $("#pengelolaan_keuangan_haji .penyertaan_saham").addClass('active');
</script>
