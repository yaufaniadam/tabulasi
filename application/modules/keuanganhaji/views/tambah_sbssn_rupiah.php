    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('keuanganhaji/import_sbssn_rupiah/'.$file_excel), 'class="form-horizontal"' );
          ...
          echo " <a class='btn btn-warning' href='".base_url("keuanganhaji/sbssn_rupiah")."'>Cancel</a>";          
          
          echo form_close(); 

        } else {

          echo form_open_multipart(base_url('keuanganhaji/tambah_sbssn_rupiah'), 'class="form-horizontal"' )?> 
            <div class="form-group">
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/keuanganhaji/pengelolaan/sbssn_rupiah.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
...
<script>
    ...
    $("#pengelolaan_keuangan_haji .sbssn_rupiah").addClass('active');
</script>
