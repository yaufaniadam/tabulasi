<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Tambah Surat Berharga Negara (SBN) - SBSN USD </h1>        
</section>
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo " <a class='btn btn-warning' href='".base_url("keuanganhaji/sbssn_usd")."'>Cancel</a>";          
            ...
            <div class="form-group">
             <p class="alert alert-warning"><i class="fa fa-exclamation-triangle"></i><strong> Panduan Import Data</strong></p>
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/keuanganhaji/pengelolaan/sbssn_usd.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
