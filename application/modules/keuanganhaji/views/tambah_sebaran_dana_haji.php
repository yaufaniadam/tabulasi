<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Porsi Penempatan di Bank BPS-BPIH </h1>        
</section>
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('keuanganhaji/import_sebaran_dana_haji/'.$file_excel), 'class="form-horizontal"' );
          ...
          foreach($sheet as $row){ 
            ...
            if($numrow > 1){
              ...
              echo "<td class='text-center'>".$bulan." " . $sheet['1']['C'] ."</td>";
          ...
          echo form_open_multipart(base_url('keuanganhaji/tambah_porsi_penempatan_bps_bpih'), 'class="form-horizontal"' )?> 
            <div class="form-group">
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/keuanganhaji/pengelolaan/porsi_penempatan_di_bank_bps_bpih.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
