...
<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Neraca <a href="<?= base_url('laporankeuangan/neraca/' . $tahun); ?>" class="btn btn-warning btn-sm"><i class="fas fa-chevron-left"></i>&nbsp; Kembali</a>
	</h1>
</section>
