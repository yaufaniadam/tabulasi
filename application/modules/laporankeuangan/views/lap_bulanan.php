<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Laporan Operasional Bulanan 

		<a href="<?=base_url('laporankeuangan/tambah_lap_bulanan'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i>&nbsp; Tambah Data</a>

		<a href="<?=base_url('laporankeuangan/export_lap_bulanan/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
...
<section class="content"> 	
  	<div class="row no-gutters" style="" >
  		...
  		<div class="well well-sm pre-scrollable" style="overflow-x: scroll; min-height:500px;">
			<table id="table1" class="table table-striped table-bordered" style="width:<?=count($lap_bulanan)*200; ?>px;;min-width: 100%;">
				...
				<tr>
					...
					<th style="text-align: right"><?=$row['bulan']; ?> &nbsp;
						...
						<a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger" data-href="<?=base_url('laporankeuangan/hapus_lap_bulanan/'.$row['id']); ?>" data-toggle="modal" data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>
