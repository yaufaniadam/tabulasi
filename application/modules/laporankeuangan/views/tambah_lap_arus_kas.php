<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Tambah Laporan Arus Kas </h1>        
</section>
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('laporankeuangan/import_lap_arus_kas/'.$file_excel), 'class="form-horizontal"' );
          ...
          <?php
            ...
            echo "  <a class='btn btn-warning' href='".base_url("laporankeuangan/lap_arus_kas")."'>Cancel</a>";
          }
          ...
          echo form_open_multipart(base_url('laporankeuangan/tambah_lap_arus_kas'), 'class="form-horizontal"' )?> 
            <div class="form-group">
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/lapkeuanganhaji/lap_arus_kas.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
