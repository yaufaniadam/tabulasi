<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Tambah Laporan Perubahan Aset Neto </h1>        
</section>
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('laporankeuangan/import_perubahan_asetneto/'.$file_excel), 'class="form-horizontal"' );
          ...
          <?php
            ...
            echo "  <a class='btn btn-warning' href='".base_url("laporankeuangan/perubahan_asetneto")."'>Cancel</a>";
          }
          ...
          echo form_open_multipart(base_url('laporankeuangan/tambah_perubahan_asetneto'), 'class="form-horizontal"' )?> 
            <div class="form-group">
             <p class="alert alert-warning"><i class="fa fa-exclamation-triangle"></i><strong> Panduan Import Data</strong></p>
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/lapkeuanganhaji/perubahan_aset_neto.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
