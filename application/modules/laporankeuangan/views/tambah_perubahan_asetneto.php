<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Tambah Perubahan Aset Neto</h1>
</section>
          ...
          ?>
            ...
            <div class="form-group">
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?= base_url('public/template-excel/lapkeuanganhaji/perubahan_asetneto.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
