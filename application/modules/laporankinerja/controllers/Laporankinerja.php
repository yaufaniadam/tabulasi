...
class Laporankinerja extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('laporankinerja_model', 'laporankinerja_model');
	}
	...
	public function tambah_pencapaian_perbidang()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$upload_path = './uploads/excel/laporankinerja';
	...
	public function import_pencapaian_perbidang($file_excel)
	{
		...
		redirect("laporankinerja/pencapaian_perbidang"); // Redirect ke halaman awal (ke controller siswa fungsi index)
	}
	...
	public function import_penyerapan_perbidang($file_excel)
	{
		...
		redirect("laporankinerja/penyerapan_perbidang"); // Redirect ke halaman awal (ke controller siswa fungsi index)
	}
