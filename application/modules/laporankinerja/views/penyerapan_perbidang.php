<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Laporan Penyerapan Anggaran Perbidang <a
			href="<?= base_url('laporankinerja/tambah_penyerapan_perbidang'); ?>" class="btn btn-warning btn-sm"><i
				...
				<tr>
					...
					<td class="text-center">
						...
						<a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger"
							...
							<a href="<?= base_url('laporankinerja/export_penyerapan_perbidang/' . $row['bulan'] .'/'. $thn); ?>" class="btn btn-success btn-xs"><i
