<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Nilai Manfaat Investasi <a href="<?=base_url('nilaimanfaat/tambah_per_instrumen'); ?>" class="btn btn-default btn-sm">Tambah Data</a></h1>
...
<section class="content">
  	...
  	<div class="row no-gutters">
  		<div class="col-md-12">
  			<h4 style="text-align: center; text-transform: uppercase;margin-bottom: 20px;"> Nilai Manfaat Investasi Per-Instrumen Periode <?=$per_instrumen['bulan'];?> <br><br><a href="<?=base_url('nilaimanfaat/per_instrumen'); ?>" class="btn btn-warning btn-sm"><i class="fa fa-chevron-circle-left"></i> &nbsp; Kembali</a></h4>     
