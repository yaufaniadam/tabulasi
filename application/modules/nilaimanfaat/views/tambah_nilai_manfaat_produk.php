    ...
    <div class="col-md-12">
      <div class="box">
        ...
        if(isset($_POST['submit'])) {
          ...
          echo form_open_multipart(base_url('nilaimanfaat/import_nilai_manfaat_produk/'.$file_excel), 'class="form-horizontal"' );
          ...
          <?php
            ...
            echo " <a  class='btn btn-warning' href='".base_url("nilai_manfaat/produk")."'>Cancel</a>";
          }
          ...
          echo form_open_multipart(base_url('nilaimanfaat/tambah_nilai_manfaat_produk'), 'class="form-horizontal"' )?> 
            <div class="form-group">
              ...
              <ol class="panduan-pengisian">
                ...
                <li>Data yang diimport harus mengikuti template yang sudah disediakan. <a href="<?=base_url('public/template-excel/nilaimanfaat/nilai_manfaat_produk_penempatan.xlsx'); ?>" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Unduh Template Excel</a></li>
