<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class KeuanganHaji extends MY_Controller {
		...
		public function index($jenis_penempatan = 0, $tahun = 0, $lembaga = 0, $quartal = 0 ){	
			...
			$data['penempatan'] =  $this->keuanganhaji_model->get_all_penempatan('kh',$jenis_penempatan, $tahun, $lembaga, $quartal);
			$data['total_penempatan'] =  $this->keuanganhaji_model->get_total_return('kh',$jenis_penempatan, $tahun, $lembaga, $quartal);
			$data['title'] = 'Jenis Penempatan';
			$data['view'] = 'keuanganhaji/index';
		...
		public function grafik($jenis_penempatan = 0, $tahun = 0, $lembaga = 0, $quartal = 0  ){	
			...
			$data['jenis_penempatan'] = $this->penempatan_model->get_jenis_penempatan($jenis_penempatan);
			$data['penempatan'] =  $this->keuanganhaji_model->get_grafik('kh',$jenis_penempatan, $tahun, $lembaga, $quartal);
			$data['total_penempatan'] =  $this->keuanganhaji_model->get_total_return('kh',$jenis_penempatan, $tahun, $lembaga, $quartal);
			$data['title'] = 'Jenis Penempatan';
			$data['view'] = 'keuanganhaji/grafik';
			$this->load->view('admin/layout', $data);
