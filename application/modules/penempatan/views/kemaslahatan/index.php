<section class="content-header">
  <h1>Dana Kemaslahatan Haji <a href="<?= base_url('penempatan/tambah/kk/'.$jenis_penempatan['slug']) ?>" class="btn btn-default btn-sm">Tambah Penempatan</a></h1>
</section>
    ...
    <div class="col-md-12">
        ...
        <div class="box">   
          <div class="box-header">
            ...
            <a href="<?= base_url('penempatan/kemaslahatan/grafik/'.$jenis_penempatan['slug']) ?>" class="btn btn-default btn-md pull-right"><i class="fas fa-chart-area"></i> Lihat Grafik</a>
          </div>     
...
<script>
  $("#dana_kemaslahatan").addClass('active');
  $("#dana_kemaslahatan .<?=$jenis_penempatan['slug']; ?>").addClass('active');
</script