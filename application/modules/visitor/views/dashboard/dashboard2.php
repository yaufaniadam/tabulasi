	...
	<div class="row">
		<div class="col-md-6">
          ...
          <p class="text-center" style="margin-top:50px;">
            <a href="<?= base_url('visitor/keuanganhaji/porsi_penempatan_bps_bpih/'); ?>" class="btn btn-md btn-warning">
      ...
      <div class="box box-success">
        ...
        <div class="box-body">
          <div class="chart">
            ...
            <p class="text-center" style="margin-top:50px;">
              <a href="<?= base_url('visitor/keuanganhaji/sbssn_rupiah/'); ?>" class="btn btn-md btn-success">Lihat Porsi
              Investasi</a>       
            </p>
          </div>
        </div>
        ...
        <div class="box-body">
          <ul style="list-style: none;">
              <?php foreach($all_grafik as $row) {
                ...
                <a class="btn btn-md btn-warning" href="'.base_url('visitor/dashboard/index/'. $row['tahun']).'">'.$row['tahun'] .'</a></li>';
              } ?>
          </ul>
        </div>
        <!-- /.box-body -->
