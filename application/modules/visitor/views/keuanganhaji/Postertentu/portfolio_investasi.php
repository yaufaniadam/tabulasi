<section class="content-header">
  <h1><i class="fa fa-kaaba"></i> Portfolio Investasi BPKH 

    <a href="<?=base_url('keuanganhaji/postertentu/tambah_portfolio_investasi'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i>&nbsp;  Tambah Data</a>

    <a href="<?=base_url('keuanganhaji/postertentu/export_portfolio_investasi/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
...
<section class="content">   
    <div class="row no-gutters" style="" >
      ...
      <div class="well well-sm pre-scrollable" style="overflow-y:hidden;overflow-x: scroll; min-height:640px;">
      <table id="table1" class="table table-striped table-bordered" style="width:<?=count($portfolio_investasi)*190;?>px; min-width: 50%">
       
          <tr class="mainheadingtable">
            <th style="width:25%;" class="first"><strong>Uraian</strong></td> 
              <?php foreach ($portfolio_investasi as $row) { ?>
              <th style="text-align: right; width:20%"><?=$row['bulan']; ?> 

                <a style="color:#fff;" title="Hapus" class="delete btn btn-xs btn-danger" data-href="<?=base_url('keuanganhaji/postertentu/hapus_portfolio_investasi/'.$row['id_portfolio_investasi']); ?>" data-toggle="modal" data-target="#confirm-delete"> <i class="fa fa-trash-alt"></i></a>
