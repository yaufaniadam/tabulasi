 <section class="content-header">
  <h1><i class="fa fa-kaaba"></i> &nbsp; Reksadana Pasar Uang Syariah  

    <a href="<?=base_url('visitor/keuanganhaji/export_reksadana_pasar_uang_syariah/'.$thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp;  Export Data ke Excel</a>
</h1>
