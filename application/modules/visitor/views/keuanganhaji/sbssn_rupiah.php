<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Laporan SBSSN Rupiah </h1>
</section>
				...
				<tr>
					...
					<td class="text-center">
						...
						<a style="color:#fff;" title="Lihat Detail" class="btn btn-xs btn-info"
							href="<?= base_url('visitor/' . $this->router->fetch_class() . '/detail_sbssn_rupiah/' . $row['bulan'] .'/' .$row['tahun']); ?>">
							<i class="fa fa-eye"></i></a>

							<a href="<?= base_url('visitor/keuanganhaji/export_sbssn_rupiah/'. $row['bulan'] .'/' . $thn); ?>" class="btn btn-success btn-xs"><i
