<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Neraca
		...
		<a href="<?= base_url('visitor/laporankeuangan/export_neraca/' . $thn); ?>" class="btn btn-success btn-sm"><i class="fas fa-file-excel"></i>&nbsp; Export Data ke Excel</a>
...
<section class="content">
	<div class="row no-gutters">
		...
		<tr class="uang">
			<td class="pertama">
				<a
					href="<?=base_url('laporankeuangan/neraca_detail/'.$neraca['id']); ?>"><strong><?=konversiTanggalAngkaKeNama($neraca['date']);?></strong></a>
				<a title="Lihat Periode <?=konversiTanggalAngkaKeNama($neraca['date']);?>"
					class="btn btn-default btn-xs"
					href="<?=base_url('laporankeuangan/detail_neraca/'.$neraca['id']); ?>"><i
						class="fa fa-search"></i></a> <a style="color:#fff;" title="Hapus"
					class="delete btn btn-xs btn-danger"
					data-href="<?=base_url('laporankeuangan/hapus_neraca/'.$neraca['id']); ?>" data-toggle="modal"
