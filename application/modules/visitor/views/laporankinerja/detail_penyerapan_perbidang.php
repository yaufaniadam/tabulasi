...
<section class="content-header">
	<h1><i class="fa fa-kaaba"></i> Laporan Penyerapan Anggaran Perbidang <a
			href="<?= base_url('visitor/laporankinerja/penyerapan_perbidang/'.$tahun); ?>" class="btn btn-warning btn-sm"><i
			...
			<div class="box">
				<div class="box-body my-form-body">
					...
					<table id="table1" class="table table-striped table-bordered">
						<tr>
							<th>Bidang</th>
							<th class="text-center">RKAT-P</th>
							<th class="text-center">RKAT-P Efisiensi</th>
