				...
				<tr>
					...
					<td class="text-center">
						...
						<a style="color:#fff;" title="Lihat Detail" class="btn btn-xs btn-info"
							href="<?= base_url('visitor/'.$this->router->fetch_class() . '/detail_penyerapan_perbidang/' . $row['bulan'] .'/' .$row['tahun']); ?>">
							<i class="fa fa-eye"></i></a>

						
							<a href="<?= base_url('visitor/laporankinerja/export_penyerapan_perbidang/' . $row['bulan'] .'/'. $thn); ?>" class="btn btn-success btn-xs"><i
